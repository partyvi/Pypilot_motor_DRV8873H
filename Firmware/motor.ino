...
*	  7/21/2019	Support added:for H bridge DRV8873H and Magnetic rotation sensor AMS5601 for rudder sensor
*	  
*/
...
//#define AMS5601rudderSensor_debug
...
#else
	uint16_t max_current = 1000; // 10 Amps
#endif 
...
void process_packet()
{
    ...
    case MAX_CURRENT_CODE: { // current in units of 10mA
		...
		#else
			unsigned int max_max_current = 10000; // for DRV8873H - 10 amp
		#endif
...
void loop()
{
    ...
    #ifdef AMS5601rudderSensor_debug 
          debug("Rudder magnet=%d strength=%d raw=%d OUT=%d\n\r",rudder_sensor.getMagnetStrength(),rudder_sensor.getMagnitude(),rudder_sensor.getRawAngle(),v);
     #endif
